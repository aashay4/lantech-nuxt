      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        data-full-width-responsive="true">
          ...
          <div class="w3-hover-shadow w3-panel w3-card w3-leftbar w3-light-grey" style="height: 460;"><br>
                    ...
                    <button v-on:click="sha1create()" class="w3-button w3-border w3-teal w3-padding-large w3-hover-gray" style="display: inline-block">SHA-512 Hash generator</button>
                    ...
                    <div class="w3-border w3-padding-large w3-padding-32 w3-right" style="width: 100%; height: 150px; overflow: scroll;"><b>SHA-512:</b> {{ answer }}</div><br><br>
                    </div>
        </div>
      </div>
              <div class="w3-padding">
                <h1 class="w3-center">How does SHA-512 Hash Generator Works?</h1>
                <p></p>
              </div>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'SHA-512 Hash generator' }
  ],
  link: [
 {rel: 'canonical', href: 'https://lantechinfocom.co.in/sha-512-hash-generator'}
]
}
},
components: {
...
methods: {
  ...
  async sha1create(){
    await this.$axios.$post('/api/sha512', {
